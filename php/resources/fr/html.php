...
<P>Une erreur est survenue pendant le processus d'enregistrement. Essayez s'il-vous-plaît de vous <A HREF="<?php echo $oGEREMO->getResetURL(); ?>">enregistrer</A> à nouveau.</P>
<?php } ?>
